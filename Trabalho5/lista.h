...
// //? Caracterização da Lista com elementos String
// // MUDANÇA AQUI: O elemento agora é um ponteiro para char (string)
// typedef char* elem;
...
// // Usamos 'const char*' para indicar que a função não modificará a string de entrada.
